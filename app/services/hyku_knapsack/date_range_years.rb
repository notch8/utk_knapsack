...
module HykuKnapsack
  # Derive plain integer years from the EDTF-ish values in UTK's machine-readable
  # date properties, for indexing into a numeric Solr field that Blacklight's
  # range limit can facet and chart.
